...
public class EvalModel {
	/*
	  但是，只实现了PieceValue和PiecePosition，所以数组的大小为2.
	 */
	...
	public int eval(Board board, char player) {
		for (Map.Entry<String, Piece> stringPieceEntry : board.pieces.entrySet()) {
			...
			/*
			  在计件位置的表格是为红色球员在默认情况下。eval黑方玩家需要执行镜像转换。
			 */
	...
	private int evalPiecePosition(int p, int[] pos) {
		int[][] pPosition = new int[][] { { 6, 4, 0, -10, -12, -10, 0, 4, 6 }, { 2, 2, 0, -4, -14, -4, 0, 2, 2 },
				...
				{ -2, 0, 4, 2, 6, 2, 4, 0, -2 }, { 0, 0, 0, 2, 4, 2, 0, 0, 0 }, { 4, 0, 8, 6, 10, 6, 8, 0, 4 },
				{ 0, 2, 4, 6, 6, 6, 4, 2, 0 }, { 0, 0, 2, 6, 6, 6, 2, 0, 0 } };
		int[][] mPosition = new int[][] { { 4, 8, 16, 12, 4, 12, 16, 8, 4 }, { 4, 10, 28, 16, 8, 16, 28, 10, 4 },
				...
				{ 0, -4, 0, 0, 0, 0, 0, -4, 0 } };
		int[][] jPosition = new int[][] { { 14, 14, 12, 18, 16, 18, 12, 14, 14 },
				{ 16, 20, 18, 24, 26, 24, 18, 20, 16 }, { 12, 12, 12, 18, 18, 18, 12, 12, 12 },
				{ 12, 18, 16, 22, 22, 22, 16, 18, 12 }, { 12, 14, 12, 18, 18, 18, 12, 14, 12 },
				{ 12, 16, 14, 20, 20, 20, 14, 16, 12 }, { 6, 10, 8, 14, 14, 14, 8, 10, 6 },
				{ 4, 8, 6, 14, 12, 14, 6, 8, 4 }, { 8, 4, 8, 16, 8, 16, 8, 4, 8 },
				{ -2, 10, 6, 14, 12, 14, 6, 10, -2 } };
		int[][] zPosition = new int[][] { { 0, 3, 6, 9, 12, 9, 6, 3, 0 }, { 18, 36, 56, 80, 120, 80, 56, 36, 18 },
				{ 14, 26, 42, 60, 80, 60, 42, 26, 14 }, { 10, 20, 30, 34, 40, 34, 30, 20, 10 },
				{ 6, 12, 18, 18, 20, 18, 18, 12, 6 }, { 2, 0, 8, 0, 8, 0, 8, 0, 2 }, { 0, 0, -2, 0, 4, 0, -2, 0, 0, 0 },
