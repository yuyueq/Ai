...
/**
 * 这是自己找的一份字体选择器的资料 新建一个类引入系统字体的样式包
 * 
 * @author Yujie_Yang
 */
public class MQFontChooser extends JDialog {
	 ...
	 * 中文预览的字符串
	 */
	private static final String CHINA_STRING = "这是一个记事本！";
	/**
	 * 英文预览的字符串
	 */
	private static final String ENGLISH_STRING = "Hello Notepad！";
	/**
	 * 数字预览的字符串
	 */
	private static final String NUMBER_STRING = "5201314";
	// 预设字体，也是将来要返回的字体
